...
for i = 1:30
    name = sprintf('/home/qicheng/Deep/cell_segmentation_data_source/tissue_images/%d.tif', i)
    source=imread(name);
    target=imread('/home/qicheng/Deep/cell_segmentation_data_source/tissue_images/17.tif');
